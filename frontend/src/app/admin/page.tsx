                            ...
                            {showCourseForm && (
                                <div className="rounded-xl border border-blue-200 bg-blue-50 p-4 mb-6 space-y-3">
                                    <div className="flex justify-between items-center mb-1">
                                        <h3 className="font-bold text-blue-900">{editingCourse ? 'Edit Course' : 'Create New Course'}</h3>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        <select value={courseForm.category} onChange={(e) => setCourseForm({ ...courseForm, category: e.target.value })} className="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm bg-white">
                                        ...
                                        <div className="p-4">
                                            <div className="flex items-start justify-between">
                                                ...
                                                <div className="flex gap-1 shrink-0">
                                                    ...
                                                    <button onClick={() => handleEditCourseInfo(course)} className="rounded p-1.5 text-slate-400 hover:bg-slate-100 hover:text-amber-600 transition" title="Edit Course Info">
