    ...
    return (
        <div className="bg-slate-50 min-h-screen flex flex-col font-sans overflow-x-hidden">
                ...
                <div className="bg-white rounded-2xl p-8 md:p-12 shadow-sm border border-slate-200 flex flex-col lg:flex-row items-center justify-between gap-12 relative overflow-hidden">
                    ...
                    <div className="flex flex-col items-center lg:items-start text-center lg:text-left flex-1 z-10">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                            ...
                            <Link href="/courses" className="flex items-center justify-center gap-2 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 px-6 py-3.5 rounded-lg font-medium transition-colors">
            ...
            <footer className="bg-white border-t border-slate-100 py-8 text-center mt-auto">
                <p className="text-slate-400 text-sm">© 2024 LearnFlow. Clinical Academy of Nursing Professionals.</p>
            </footer>
        </div>
    );
}
