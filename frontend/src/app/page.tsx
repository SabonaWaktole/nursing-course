  ...
  return (
    <div className="flex flex-col">
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-center">
            ...
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
              ...
              <p className="text-lg text-slate-600 dark:text-slate-400 mb-10 leading-relaxed">
                Industry-leading SaaS platform for CNA professional development. Access state-approved courses, expert-led training, and career advancement tools designed for the modern healthcare professional.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 sm:justify-center lg:justify-start">
                ...
                <Link href="/register" className="px-8 py-4 bg-white dark:bg-slate-800 text-slate-900 dark:text-white font-bold rounded-xl border border-slate-200 dark:border-slate-700 hover:bg-slate-50 transition-all text-lg text-center">
                  View Demo
                </Link>
              </div>
              {/* Social proof */}
            ...
            <div className="mt-16 lg:mt-0 lg:col-span-6 relative">
              <div className="relative mx-auto w-full rounded-2xl shadow-2xl overflow-hidden border-8 border-white dark:border-slate-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {courses.length > 0 ? courses.map((course, idx) => (
              <Link
                ...
                className="bg-white dark:bg-slate-900 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 group transition-all hover:shadow-2xl hover:shadow-primary/10"
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between pt-6 border-t border-slate-100 dark:border-slate-800">
                    ...
                    <span className="p-2 bg-slate-50 dark:bg-slate-800 rounded-lg hover:bg-primary hover:text-white transition-colors">
      ...
      <section className="py-24 bg-white dark:bg-background-dark">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 dark:text-slate-400">Hear from professionals who advanced their careers with CNA Pro.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {TESTIMONIALS.map((t) => (
              <div key={t.name} className="bg-background-light dark:bg-slate-800/50 p-8 rounded-2xl relative">
      ...
      <section className="py-20 px-4">
        <div className="max-w-5xl mx-auto bg-primary rounded-[2rem] p-12 text-center text-white relative overflow-hidden shadow-2xl shadow-primary/40">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
            <Link href="/register" className="px-10 py-4 bg-white text-primary font-bold rounded-xl hover:bg-slate-50 transition-all shadow-lg text-lg">Create Free Account</Link>
            <Link href="/courses" className="px-10 py-4 bg-primary border-2 border-white/30 text-white font-bold rounded-xl hover:bg-white/10 transition-all text-lg">Compare Plans</Link>
          </div>
        </div>
      </section>
    </div>
